var initRDKitModule = (() => {
	...
	return async function (moduleArg = {}) {
		...
		function assignWasmExports(wasmExports) {
			...
			_malloc = wasmExports['X'];
			_free = wasmExports['Y'];
			_emscripten_builtin_memalign = wasmExports['Z'];
			_emscripten_stack_get_end = wasmExports['_'];
			___trap = wasmExports['$'];
			_emscripten_stack_init = wasmExports['aa'];
